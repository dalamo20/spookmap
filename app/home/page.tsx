        ...
        <div className="home-container">
          <div className="nav-div">
            ...
            <div className="btn-cont">
                <button className="collections-btn" onClick={() => router.push('/collections')}>
          ...
          <img
              ...
              className="user-img"
            />
            <p style={{ paddingLeft: '20px' }}>Hello, {session.user?.username ? session.user.username : session.user.email}</p>
          </div>
          <Map /> 
        </div>
        </>
